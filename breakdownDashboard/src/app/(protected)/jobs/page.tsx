...
export default function FleetJobsPage() {
  ...
  const fetchTechnicians = async () => {
    const { data, error } = await supabase.from('technicians').select('*').neq('isActive', false);
    if (error) {
          ...
          <div className="flex items-center space-x-2">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Technician on site">Technician On Site</SelectItem>
                <SelectItem value="Technician accepted">Technician accepted</SelectItem>
        ...
        <Tabs defaultValue="list" className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2">
                              ...
                              <CardTitle className="text-lg">{job.job_id} :  {job?.vehiclesc?.registration_number || "No vehicle allocated"}</CardTitle>
                            </div>
                                ...
                                return (
                                  <div key={index} className="flex flex-col items-center gap-1">
                                    ...
                                    <a href={url} target="_blank" rel="noopener noreferrer">
                                      <Button variant="outline" size="icon" className="flex flex-row gap-2 w-fit p-2">
          ...
          <TabsContent value="kanban" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {["Breakdown Request", "inprogress", "assigned", "Technician accepted", "Technician on site", "completed"].map((status) => (
                <Card key={status}>
                  <CardHeader className="pb-3">
