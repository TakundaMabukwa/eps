-- Enhanced Audit System for Planned vs Actual vs Variance Analysis

-- 1. Add missing columns to audit table
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_start_time timestamp with time zone;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_finish_time timestamp with time zone;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_distance numeric(10, 2);
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_duration_minutes integer;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_driving_time_minutes integer;

ALTER TABLE audit ADD COLUMN IF NOT EXISTS actual_start_time timestamp with time zone;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS actual_finish_time timestamp with time zone;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS actual_duration_minutes integer;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS actual_driving_time_minutes integer;

ALTER TABLE audit ADD COLUMN IF NOT EXISTS start_time_variance_minutes integer;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS finish_time_variance_minutes integer;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS distance_variance numeric(10, 2);
ALTER TABLE audit ADD COLUMN IF NOT EXISTS duration_variance_minutes integer;
ALTER TABLE audit ADD COLUMN IF NOT EXISTS driving_time_variance_minutes integer;

ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_fuel_cost numeric(10, 2);
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_vehicle_cost numeric(10, 2);
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_driver_cost numeric(10, 2);
ALTER TABLE audit ADD COLUMN IF NOT EXISTS planned_total_cost numeric(10, 2);
...
BEGIN
    ...
    IF NEW.total_distance IS NOT NULL AND 
       (OLD IS NULL OR OLD.total_distance IS NULL OR OLD.total_distance != NEW.total_distance) THEN
        ...
        -- Insert or update audit record with comprehensive data
        INSERT INTO audit (
            ...
            status_history, load_inspection_id,
        ...
        VALUES (
            ...
            NOW(), NEW.status_history, NEW.load_inspection_id,
        ...
        RAISE NOTICE 'Enhanced audit record processed for trip_id: %', NEW.trip_id;
    END IF;
...
SELECT 
    ...
    -- Variance calculations
    start_time_variance_minutes,
    finish_time_variance_minutes,
    distance_variance,
    duration_variance_minutes,
    (actual_total_cost - planned_total_cost) as cost_variance
FROM audit 
