...
export default function HomeScreen() {
  ...
  const emergency = () => {
    ...
    if (inspection.inspected === false || inspection === undefined || inspectionDate !== todayDate) {
      router.push('/(tabs)/inspection');
    } else {
      router.push('/(tabs)/emergency');
    }
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent]}
        ...
        {/* Location Section */}
        <View style={[styles.sectionCard, { backgroundColor: theme.background, shadowColor: theme.icon }]}>
          <View style={[styles.iconCircle, { backgroundColor: colorScheme === 'dark' ? '#23272e' : '#f1f4f0' }]}>
            <ThemedText style={{ fontSize: 26 }}>📍</ThemedText>
          </View>
          <View style={{ flex: 1 }}>
            <ThemedText type="subtitle" style={styles.sectionTitle}>Your Location</ThemedText>
            <LocationScreen />
          </View>
        </View>
        ...
        <View style={styles.banner}>
          ...
          <ThemedText type="title" style={styles.bannerText}>Stay Safe on the Road</ThemedText>
        </View>

        {/* Emergency Section */}
        { }
        <TouchableOpacity
          style={[styles.sectionCard, { backgroundColor: theme.background, shadowColor: theme.icon }]}
          // onPress={emergency}
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <ThemedText type="subtitle" style={styles.sectionTitle}>Emergency Assistance</ThemedText>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <ThemedText type="subtitle" style={styles.sectionTitle}>Vehicle Inspections</ThemedText>
            <ThemedText style={styles.sectionDesc}>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <ThemedText type="subtitle" style={styles.sectionTitle}>View Breakdown Status</ThemedText>
            <ThemedText style={styles.sectionDesc}>
        ...
        {/* Tips Section */}
        <View style={[styles.tipsCard, { backgroundColor: colorScheme === 'dark' ? '#23272e' : '#eaf5e6' }]}>
          <ThemedText type="subtitle" style={styles.tipsTitle}>Safety Tips</ThemedText>
          <ThemedText style={styles.tipsText}>• Always wear your seatbelt</ThemedText>
          <ThemedText style={styles.tipsText}>• Keep emergency contacts updated</ThemedText>
          <ThemedText style={styles.tipsText}>• Regularly inspect your vehicle</ThemedText>
          <ThemedText style={styles.tipsText}>• Don’t use your phone while driving</ThemedText>
        </View>
      </ScrollView>
    </View>
  );
